...
| [docs/project-groups.md](docs/project-groups.md)                     | Sidebar project groups — tree model, depth cap, menu-not-drag assignment, mode behaviour, persistence boundary                 |
